...
const messages = defineMessages({
  ...
  edit_trip: 'Edit trip',
  delete_company_title: 'Delete trip?',
  delete_company_message: 'The trip will be deleted!',
  destination_label: 'Destination',
  destination_hint: 'Enter destination',
  start_date_label: 'Start Date',
  start_date_hint: 'Enter Start Date',
  end_date_label: 'End Date',
  end_date_hint: 'Enter End Date',
  comment_label: 'Comment',
  comment_hint: 'Enter comment',
  name_label: 'Name',
  ...
  private: 'Private',
  public: 'Public',
  grant_read_companies: 'Read trips',
  grant_create_company: 'Create trip',
  grant_edit_company: 'Edit trip',
  grant_delete_company: 'Delete trip',
